...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 14 2017 г., 16:04
...
(44, 10, 0, '', 'Про нас@|;О нас@|;About us@|;', '@|;@|;@|;', '<p>Візуальний стиль Stack є простим, але виразним ідеально підходить для будь-якого проекту, будь то основний сайт маркетингу або багатосторінкового присутність компанії. Stack пропонує масивне значення з сучасним дизайном</p>@|;<p>Визуальный стиль Stack прост, но отличен для любого проекта, будь то базовый маркетинговый сайт или присутствие на нескольких страницах компании. Stack предлагает огромную ценность с современным стилем.</p>@|;<p>Stack&#39;s visual style is simple yet distinct perfect for any project whether it be a basic marketing site, or multi-page company presence. Stack offers massive value with modern styling.</p>@|;', '', '', '', '', 0, '0000-00-00 00:00:00', 'Byben@|;Byben@|;Byben@|;', 'Міжнародні дзвінки з Byben@|;Международные звонки с Byben@|;Сheap international calls with Buben@|;', 'Buben@|;Buben@|;Buben@|;', 1, '2017-04-14 11:40:53', '2017-04-14 11:40:53');
...
(10, 0, 0, 'page', 'Статичні сторінки@|;Статические страницы@|;Static pages@|;', '', '@|;@|;@|;', '@|;@|;@|;', '[]', '{"base":["title","description","priority","active","meta_title","meta_description","meta_keywords"],"attributes":{}}', '0000-00-00 00:00:00', 1, '@|;@|;@|;', '@|;@|;@|;', '@|;@|;@|;', 0, '2017-04-14 11:04:41', '2017-04-14 11:35:43');
