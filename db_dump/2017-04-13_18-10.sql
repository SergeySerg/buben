...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 13 2017 г., 18:10
...
(8, 0, 0, 'faq', 'F.A.Q.@|;F.A.Q.@|;F.A.Q.@|;', '', '@|;@|;@|;', '@|;@|;@|;', '[]', '{"base":["title","short_description","priority","active"],"attributes":{}}', '0000-00-00 00:00:00', 1, 'Buben | FAQ@|;Buben | FAQ@|;Buben | FAQ@|;', '@|;@|;@|;', '@|;@|;@|;', 0, '2017-04-09 19:38:51', '2017-04-13 15:04:40'),
