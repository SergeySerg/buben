...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 11 2017 г., 22:29
...
(5, 0, 0, 'price', 'О нас@|;About us@|;', '', '@|;@|;', '@|;@|;', '[]', '{"base":["title","short_description","priority","active"],"attributes":{"Картинка":{"type":"files","lang_active":false,"active":true}}}', '0000-00-00 00:00:00', 1, '@|;@|;', '@|;@|;', '@|;@|;', 0, '2017-04-09 19:22:36', '2017-06-16 12:33:52'),
